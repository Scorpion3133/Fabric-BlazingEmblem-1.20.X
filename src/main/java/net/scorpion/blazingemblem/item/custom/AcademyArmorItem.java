...
import net.scorpion.blazingemblem.item.client.AcademyArmorRenderer;
...
public class AcademyArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public AcademyArmorItem(ArmorMaterial material, Type type, Settings settings) {
        ...
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity entity, ItemStack stack,
                ...
                if (this.renderer == null)
                    this.renderer = new AcademyArmorRenderer();
